...
#### Added 
- 1.增加创建新的session后还原默认的session的功能，方便在同一个请求上下文使用
...
- 3.增加上下文创建session的功能.
- 4.tinymysql中增加上下文管理器功能，优化参数，优化获取连接方式.
- 5.增加创建session时的校验以及创建完之后的还原

###[1.0.1] - 2020-6-14

#### Added 
- 1.增加能够选择数据库驱动的功能，默认为pymysql.
- 2.此扩展原则上将做为最后一个未拆分扩展版本,后续将分开维护.
